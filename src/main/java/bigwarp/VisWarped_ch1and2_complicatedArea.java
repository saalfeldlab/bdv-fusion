...
public class VisWarped_ch1and2_complicatedArea
{

	final static ARGBType red =  new ARGBType( ARGBType.rgba( 255, 0,  0, 255 ));
	...
	public static void main(String[] args) throws IOException, JDOMException
	{
		...
		BigWarpData data = genData( pairListCh0, pairListCh1 );

		try
		{
			System.out.println("Setting up bigwarp");
...
//			bw.loadSettings("/groups/saalfeld/home/bogovicj/projects/igor_illumiation-correction/bigwarp.settings.xml");
		}
...
//				"/groups/saalfeld/home/bogovicj/projects/igor_illumiation-correction/landmarks/ch0_18-17.csv" ));
	...
	public static BigWarpData genData( 
			...
			final LinkedList<JsonXfmPair> pairListFixed )
	{
		...
		for( int j = 0; j < pairListFixed.size(); j++ )
		{
			JsonXfmPair pair = pairListFixed.get( j );
			if( !pair.xfmF.equals( "none" ))
			{
				System.out.println( "adding warped" );
				LandmarkTableModel ltm = new LandmarkTableModel( 3 );
